...
* **Framework:** ⚡ FastAPI
* **Database:** 🗄️ SQLite (via SQLAlchemy)
* **Admin Panel:** 🛠️ SQLAdmin
* **Validation:** 🛡️ Pydantic
...
| `PUT` | `/students/{id}` | ✏️ Update info |
| `DELETE` | `/students/{id}` | 🗑️ Remove student |
...
### 📑 API Docs
Automatic documentation is generated for you (FastAPI magic ✨).
